...
const YouCanAlsoInterested = ({
  ...
  const filteredArticles = articlesList.filter(
    article => article._id !== id && article.author !== author
  );
  const displayedArticles = hideFourth
    ...
    <div>
      ...
      <div className={s.body}>
        <div className={s.topBody}>
          ...
          <p>
            <span className={s.span}>Publication date:</span>{' '}
            {isLoading ? (
              <Loader
                variant='skeleton'
                small
